...
HIGGS_V3_LANGUAGES_WITH_LOCALES = tuple(
    dict.fromkeys((*HIGGS_V3_LANGUAGE_CODES, *HIGGS_V3_LOCALE_ALIASES))
)
...
class VoicePreset:
    ...
    name: str
    description: str
    languages: tuple[str, ...] = HIGGS_V3_LANGUAGES_WITH_LOCALES
